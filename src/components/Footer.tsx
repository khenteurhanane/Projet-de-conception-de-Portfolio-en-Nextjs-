      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-20">
          ...
          <div className="lg:col-span-5 space-y-8">
            <Link href="/" className="text-2xl font-black font-outfit bg-gradient-to-r from-violet-400 to-indigo-400 bg-clip-text text-transparent leading-tight">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://linkedin.com/in/hanane-khenteur" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-violet-600 transition-all group">
                <Linkedin size={20} className="group-hover:scale-110 transition-transform" />
              </a>
              <a href="#" className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-violet-600 transition-all group">
          ...
          <div className="lg:col-span-5 space-y-6">
            <h4 className="text-sm font-black uppercase tracking-widest text-violet-500">Prenons contact</h4>
            <div className="bg-white/5 p-8 rounded-[2rem] border border-white/10 space-y-6">
              ...
              <a href="mailto:contact@mondomaine.com" className="flex items-center gap-4 text-violet-400 hover:text-violet-300 transition-colors">
        ...
        <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-12">
            <p className="text-gray-500 text-xs">
              © {currentYear} Hanane Khenteur — Tous droits réservés.
            </p>
